...
fn getStyleParams(style: []const u8) StyleParams {
    if (std.mem.eql(u8, style, "adventure")) return .{
        .melody_wf = .sine, .harmony_wf = .square, .bass_wf = .sawtooth,
        .melody_oct = 4, .bass_oct = 2,
        .melody_vol = 0.35, .bass_vol = 0.25, .harmony_vol = 0.12, .perc_vol = 1.0,
        .melody_density = 7, .swing = 0.0,
        .use_kick = true, .use_snare = true, .use_hihat = true, .use_rim = false, .use_shaker = false,
    ...
    if (std.mem.eql(u8, style, "dungeon")) return .{
        .melody_wf = .triangle, .harmony_wf = .square, .bass_wf = .sawtooth,
        .melody_oct = 4, .bass_oct = 2,
        .melody_vol = 0.30, .bass_vol = 0.28, .harmony_vol = 0.10, .perc_vol = 0.8,
        .melody_density = 5, .swing = 0.0,
        .use_kick = true, .use_snare = false, .use_hihat = true, .use_rim = true, .use_shaker = false,
        ...
        .reverb_room = 0.7, .reverb_wet = 0.35,
    };
    if (std.mem.eql(u8, style, "boss")) return .{
        .melody_wf = .sawtooth, .harmony_wf = .square, .bass_wf = .square,
        .melody_oct = 4, .bass_oct = 2,
        .melody_vol = 0.40, .bass_vol = 0.30, .harmony_vol = 0.15, .perc_vol = 1.2,
        .melody_density = 8, .swing = 0.0,
        .use_kick = true, .use_snare = true, .use_hihat = true, .use_rim = false, .use_shaker = false,
    ...
    if (std.mem.eql(u8, style, "town")) return .{
        .melody_wf = .sine, .harmony_wf = .triangle, .bass_wf = .sine,
        .melody_oct = 5, .bass_oct = 3,
        .melody_vol = 0.35, .bass_vol = 0.20, .harmony_vol = 0.10, .perc_vol = 0.5,
        .melody_density = 6, .swing = 0.2,
        .use_kick = true, .use_snare = false, .use_hihat = false, .use_rim = false, .use_shaker = true,
    ...
    if (std.mem.eql(u8, style, "battle")) return .{
        .melody_wf = .sawtooth, .harmony_wf = .pulse, .bass_wf = .sawtooth,
        .melody_oct = 4, .bass_oct = 2,
        .melody_vol = 0.38, .bass_vol = 0.30, .harmony_vol = 0.13, .perc_vol = 1.1,
        .melody_density = 8, .swing = 0.0,
        .use_kick = true, .use_snare = true, .use_hihat = true, .use_rim = false, .use_shaker = false,
    ...
    if (std.mem.eql(u8, style, "field")) return .{
        .melody_wf = .sine, .harmony_wf = .triangle, .bass_wf = .sine,
        .melody_oct = 5, .bass_oct = 3,
        .melody_vol = 0.30, .bass_vol = 0.18, .harmony_vol = 0.10, .perc_vol = 0.4,
        .melody_density = 5, .swing = 0.15,
        .use_kick = false, .use_snare = false, .use_hihat = false, .use_rim = false, .use_shaker = true,
        ...
        .reverb_room = 0.6, .reverb_wet = 0.3,
    };
    if (std.mem.eql(u8, style, "puzzle")) return .{
        .melody_wf = .square, .harmony_wf = .sine, .bass_wf = .triangle,
        .melody_oct = 5, .bass_oct = 3,
        .melody_vol = 0.25, .bass_vol = 0.18, .harmony_vol = 0.08, .perc_vol = 0.6,
        .melody_density = 6, .swing = 0.1,
        .use_kick = false, .use_snare = false, .use_hihat = true, .use_rim = true, .use_shaker = false,
    ...
    if (std.mem.eql(u8, style, "menu")) return .{
        .melody_wf = .sine, .harmony_wf = .sine, .bass_wf = .sine,
        .melody_oct = 5, .bass_oct = 3,
        .melody_vol = 0.25, .bass_vol = 0.15, .harmony_vol = 0.08, .perc_vol = 0.3,
        .melody_density = 4, .swing = 0.0,
        .use_kick = false, .use_snare = false, .use_hihat = false, .use_rim = false, .use_shaker = true,
    ...
    if (std.mem.eql(u8, style, "horror")) return .{
        .melody_wf = .triangle, .harmony_wf = .sawtooth, .bass_wf = .sine,
        .melody_oct = 4, .bass_oct = 1,
        .melody_vol = 0.22, .bass_vol = 0.25, .harmony_vol = 0.15, .perc_vol = 0.4,
        .melody_density = 3, .swing = 0.0,
        .use_kick = false, .use_snare = false, .use_hihat = false, .use_rim = true, .use_shaker = false,
        ...
        .reverb_room = 0.9, .reverb_wet = 0.5,
    };
    if (std.mem.eql(u8, style, "space")) return .{
        .melody_wf = .sine, .harmony_wf = .sine, .bass_wf = .triangle,
        .melody_oct = 5, .bass_oct = 2,
        .melody_vol = 0.28, .bass_vol = 0.18, .harmony_vol = 0.12, .perc_vol = 0.3,
        .melody_density = 4, .swing = 0.0,
        .use_kick = false, .use_snare = false, .use_hihat = true, .use_rim = false, .use_shaker = false,
        ...
        .reverb_room = 0.9, .reverb_wet = 0.45,
    };
    if (std.mem.eql(u8, style, "shop")) return .{
        .melody_wf = .square, .harmony_wf = .triangle, .bass_wf = .sine,
        .melody_oct = 5, .bass_oct = 3,
        .melody_vol = 0.30, .bass_vol = 0.20, .harmony_vol = 0.10, .perc_vol = 0.6,
        .melody_density = 7, .swing = 0.25,
        .use_kick = true, .use_snare = false, .use_hihat = false, .use_rim = false, .use_shaker = true,
    ...
    if (std.mem.eql(u8, style, "castle")) return .{
        .melody_wf = .triangle, .harmony_wf = .square, .bass_wf = .sawtooth,
        .melody_oct = 4, .bass_oct = 2,
        .melody_vol = 0.32, .bass_vol = 0.25, .harmony_vol = 0.13, .perc_vol = 0.8,
        .melody_density = 6, .swing = 0.0,
        .use_kick = true, .use_snare = true, .use_hihat = false, .use_rim = true, .use_shaker = false,
        ...
        .reverb_room = 0.7, .reverb_wet = 0.3,
    };
    if (std.mem.eql(u8, style, "underwater")) return .{
        .melody_wf = .sine, .harmony_wf = .sine, .bass_wf = .sine,
        .melody_oct = 4, .bass_oct = 2,
        .melody_vol = 0.25, .bass_vol = 0.18, .harmony_vol = 0.10, .perc_vol = 0.2,
        .melody_density = 4, .swing = 0.0,
        .use_kick = false, .use_snare = false, .use_hihat = false, .use_rim = false, .use_shaker = true,
        ...
        .reverb_room = 0.95, .reverb_wet = 0.5,
    };
    if (std.mem.eql(u8, style, "forest")) return .{
        .melody_wf = .sine, .harmony_wf = .triangle, .bass_wf = .sine,
        .melody_oct = 5, .bass_oct = 3,
        .melody_vol = 0.28, .bass_vol = 0.16, .harmony_vol = 0.09, .perc_vol = 0.3,
        .melody_density = 5, .swing = 0.2,
        .use_kick = false, .use_snare = false, .use_hihat = false, .use_rim = false, .use_shaker = true,
    ...
    if (std.mem.eql(u8, style, "cyber")) return .{
        .melody_wf = .pulse, .harmony_wf = .sawtooth, .bass_wf = .square,
        .melody_oct = 4, .bass_oct = 2,
        .melody_vol = 0.35, .bass_vol = 0.30, .harmony_vol = 0.12, .perc_vol = 1.0,
        .melody_density = 8, .swing = 0.0,
        .use_kick = true, .use_snare = true, .use_hihat = true, .use_rim = false, .use_shaker = false,
...
pub fn generate(allocator: std.mem.Allocator, config: BgmConfig) ![]f32 {
    ...
    const sp = getStyleParams(config.style);
